...
```
## Source
Source code for the demo application is hosted on GitHub in [dotnet-mysql-integration-test](https://github.com/kashif-code-samples/dotnet-mysql-integration-test) repository.

Source for `.NET MySQL Integration Tests` workflow is in [dotnet-mysql-integration-tests.yml](https://github.com/kashif-code-samples/dotnet-mysql-integration-test/blob/main/.github/workflows/dotnet-mysql-integration-tests.yml).

Source for `.NET MySQL Integration Tests with docker-compose` workflow is in [dotnet-mysql-integration-tests-docker-compose.yml](https://github.com/kashif-code-samples/dotnet-mysql-integration-test/.github/workflows/dotnet-mysql-integration-tests-docker-compose.yml).

## References
In no particular order  
* [REST API with ASP.NET Core and MySql](https://kashifsoofi.github.io/aspnetcore/rest/postgres/restapi-with-asp.net-core-and-mysql/)
